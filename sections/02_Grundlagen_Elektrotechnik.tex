...
Luft kann dabei zu den Gasen/Plasma und zu den Isolatoren gezählt werden, je nach Spannung welche herrscht.
...
\begin{minipage}[c]{0.4\linewidth}
    \begin{center}
        \includesvg[width = 0.9\linewidth, inkscapelatex=false]{svg/Elektrischer Strom.svg}
    \end{center}
\end{minipage}
...
\end{minipage}%
\begin{minipage}[t]{{0.5\linewidth}}
    Um ein Verbraucher und eine Quelle auseinander zu halten kann man sich die Richtungen der Spannung und des Stromes überprüfen. 
    Ist die Spannung und der Strom parallel zueinander, handelt es sich um ein Verbraucher(wie ein Widerstand). 
...
G ist der sogenannte elektrische Leitwert und von oben abgeleitet: $\text{G} = \dfrac{\text{I}}{\text{U}}$ in der Masseinheit \unit{\siemens}(Siemens).
...
Um trotz dem Widerstandswerte annähern zu können wird die Funktion des Widerstands angenähert. 
