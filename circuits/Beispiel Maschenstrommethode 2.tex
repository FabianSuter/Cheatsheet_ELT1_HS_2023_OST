...
\begin{circuitikz}
    ...
    \node [font=\normalsize] at (2.75,10) {$r\cdot I_s$};
    ...
    \draw [ color={rgb,255:red,217; green,0; blue,108}, ->, >=Stealth] (7,12.5) .. controls (6.25,13) and (8,13) .. (7.25,12.5) node[pos=0.5, fill=white]{$J_2$};
    \draw [ color={rgb,255:red,217; green,0; blue,108}, ->, >=Stealth] (3.5,9.25) .. controls (2.75,9.75) and (4.5,9.75) .. (3.75,9.25) node[pos=0.5, fill=white]{$J_3$};
    \draw [ color={rgb,255:red,217; green,0; blue,108}, ->, >=Stealth] (7,9.25) .. controls (6.25,9.75) and (8,9.75) .. (7.25,9.25) node[pos=0.5, fill=white]{$J_4$};
    \node at (2.25,11) [circ] {};
    \node at (5.5,11) [circ] {};
    \node at (5.5,8) [circ] {};
    \node at (8.75,11) [circ] {};
